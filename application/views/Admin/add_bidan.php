						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-gruop">
									<form action="<?php echo base_url('Admin/addBidanAction'); ?>" method="post" enctype="multipart/form-data">
										<div class="form-group row">
											<label for="fname" class="col-sm-4  control-label col-form-label">Nama Bidan</label>
											<div class="col-sm-8">
												<input type="text" style="border-radius: 10px;" name="nama_bidan" class="form-control" id="nama_bidan" placeholder="Nama Bidan" required>
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="password" style="border-radius: 10px;" name="password" class="form-control" id="password" value="12345678" readonly required>
											</div>
										</div>
										<div class="form-group row">
